export const useRefData = {
  ...
  contents: {
    ...
    paragrah03: {
      ...
      code1: `// useEffect로 title 업데이트 시 updateTitle 함수 호출
    ...
    paragrah04: {
      ...
      code1: `const updateTitle = () => {
          const htmlTitle = document.querySelector("title");
          htmlTitle.innerText = title;
  };`,
    },
    paragrah05: {
      title: "5. 그럼 언제 Hook을 쓰는 걸까?",
      text1:
    ...
    paragrah06: {
      ...
      code1: `onClick={() => setTitle("Changed!!!")}`,
      text2:
    ...
    paragrah09: {
      title: "9. 바꾸는 방법이 있긴 합니다!",
      text1:
        "'title'에 담긴 값이 클릭할 때마다 업데이트 되도록 하면 됩니다. 사실 그래서 Hook을 하나 더 만들었어요.",
      code1: `const [userTitle, setUserTitle] = useState("Read First");`,
      text2:
